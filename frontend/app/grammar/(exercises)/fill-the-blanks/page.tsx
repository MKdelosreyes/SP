...
export default function GrammarFillBlanksPage() {
  return (
    <div className="h-screen max-h-screen overflow-hidden flex flex-col bg-green-50">
      <div className="flex-shrink-0 flex items-center justify-between px-4 md:px-8 py-4 bg-white border-b border-green-200">
        <Link
          href="/grammar"
      ...
      <div className="flex-1 flex items-center justify-center">
        <div className="text-center space-y-4">
          ...
          <p className="text-gray-600">
            Grammar Fill-in-the-Blanks exercise will be available soon!
          </p>
        </div>
      </div>
    </div>
